...
<head>
    ...
    <title>Form Pendaftaran - Radar Kediri</title>
...
<body>
        ...
        <div class="main-content">
            <div class="form-container">
                <div class="form-header">
                    <h3><i class="fas fa-clipboard-list"></i> Form Pendaftaran Lowongan</h3>
                ...
                <form id="pendaftaranForm" method="POST" action="{{ route('pendaftar.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="nim_nis" id="nim_nis" class="form-control" placeholder="Masukkan NIM atau NIS" required>
                    </div>
    ...
    <script>
        document.getElementById('pendaftaranForm').addEventListener('submit', function(e) {
            ...
            // Validasi manual
            const nimNis = document.getElementById('nim_nis').value;
            if (nimNis.length < 5) {
                Swal.fire("Error", "NIM/NIS minimal 5 digit!", "error");
                return;
            }

            const alamat = document.getElementById('alamat').value;
            if (alamat.length < 10) {
                Swal.fire("Error", "Alamat minimal 10 karakter!", "error");
                return;
            }
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    form.submit(); // <--- penting, supaya data terkirim ke Laravel
                }
            });
        });
    </script>
